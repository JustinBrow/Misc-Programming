...
intReturn = wshShell.Run("C:\Windows\Microsoft.NET\Framework\v4.0.30319\csc.exe" & _
   ...
   " /target:winexe" & _
   " /optimize+" & _
   " /Win32Manifest:" & ScriptDir & "\src\" & ProjectName & ".xml" & _
   " /Resource:" & ScriptDir & "\Resources\cisco-secure-client-win-core-vpn-predeploy-k9.msi" & _
   " /Resource:" & ScriptDir & "\Resources\cisco-secure-client-win-umbrella-predeploy-k9.msi" & _
   " /Resource:" & ScriptDir & "\Resources\OrgInfo.json" & _
