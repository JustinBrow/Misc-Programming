...
intReturn = wshShell.Run("C:\Windows\Microsoft.NET\Framework\v4.0.30319\csc.exe" & _
   ...
   " " & ScriptDir & "\src\WinAPIs.cs" & _
   " " & ScriptDir & "\src\Service.cs" & _
   " " & ScriptDir & "\src\Service.Designer.cs" & _
   " " & ScriptDir & "\src\ProjectInstaller.cs" & _
   " " & ScriptDir & "\src\ProjectInstaller.Designer.cs", 0, true)
...
ElseIf intReturn <> 0 Then
   ...
   " " & ScriptDir & "\src\Service.Designer.cs" & _
   " " & ScriptDir & "\src\ProjectInstaller.cs" & _
   " " & ScriptDir & "\src\ProjectInstaller.Designer.cs")
End If
